...
\end{chapterpage}
\renewcommand{\chapterfolder}{ch_09_simple_linear_regression_oi_biostat}
...
\centering
\includegraphics[width=0.6\textwidth]
{ch_09a_simple_linear_regression_oi_biostat/figures/sampleLinesAndResPlots/sampleLinesAndResPlots.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{ch_09a_simple_linear_regression_oi_biostat/figures/prevendResidPlot/prevendResidPlot}
...
%\begin{figure}[h]
	...
	%{ch_09a_simple_linear_regression_oi_biostat/figures/prevendResidNormPlot/prevendResidNormPlot.pdf}
...
% 	\centering
% 	\includegraphics[width=0.7\textwidth]
% 	{ch_09a_simple_linear_regression_oi_biostat/figures/nhanesHeightWeightResiduals/nhanesHeightWeightResiduals.pdf}
...
\begin{figure}[h]
	...
	\subfigure[]{
		\includegraphics[width=0.485\textwidth]
		{ch_09a_simple_linear_regression_oi_biostat/figures/wdiHistTransform/wdiHistReg}
		\label{wdiHistReg}
	}
	\subfigure[]{
		\includegraphics[width=0.485\textwidth]
		{ch_09a_simple_linear_regression_oi_biostat/figures/wdiHistTransform/wdiHistLog}
		\label{wdiHistLog}
	}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{ch_09a_simple_linear_regression_oi_biostat/figures/wdiPlot/wdiPlotB}
...
\begin{figure}[h]
	...
	\subfigure[]{
		\includegraphics[width=0.485\textwidth]
		{ch_09a_simple_linear_regression_oi_biostat/figures/wdiResid/wdiResidualPlot}
		\label{wdiResidPlot}
	}
	\subfigure[]{
		\includegraphics[width=0.485\textwidth]
		{ch_09a_simple_linear_regression_oi_biostat/figures/wdiResid/wdiResidNormPlot}
...
\begin{figure}[h]
	...
	\subfigure[]{
		...
		{ch_09a_simple_linear_regression_oi_biostat/figures/infMortUS/infMortUS}
		\label{infMortUSDC}
	}
	\subfigure[]{
		\includegraphics[width=0.65\textwidth]
		{ch_09a_simple_linear_regression_oi_biostat/figures/infMortUS/infMortUSnoDC}
		\label{infMortUSnoDC}
	}
...
\begin{figure}[h]
	...
	\subfigure[]{
		\includegraphics[width=0.485\textwidth]
		{ch_09a_simple_linear_regression_oi_biostat/figures/infMortUSResid/infMortUSResidualPlot.pdf}
		\label{infMortUSResidualPlot}
	}
	\subfigure[]{
		\includegraphics[width=0.485\textwidth]
		{ch_09a_simple_linear_regression_oi_biostat/figures/infMortUSResid/infMortUSResidNormPlot.pdf}
