...
\end{chapterpage}
\renewcommand{\chapterfolder}{ch_intro_to_data_1a}


\chapterintro{Making observations and recording \term{data} form the backbone of empirical research, and represent the beginning of a systematic approach to investigating scientific questions. As a discipline, statistics focuses on addressing the following three questions in a rigorous and efficient manner:\\
  $\bullet$  How can data best be collected? \\
  $\bullet$ How should data be analyzed? \\
  $\bullet$  What can be inferred from data? \\
  %\end{itemize}   
  %\end{minipage}
%%% THIS PART IS ADDEd
 \noindent{}It is helpful to put statistics in the context of a general process of investigation:
...
6.~Interpretation of the analytical results. Decision making. 
% \end{enumerate}
Statistics focuses on stage 4-5 and try to answer: How best can we collect data? How should it be analyzed? And what can we infer from the analysis?  An Analysis of data which consists on summarizing the data information by means of numbers and graphical
  representation is called \term{descriptive statistics}. In other circumstances , we try to determine  whether the apparent differences in a quantity are real or may be due to chance. In this case,  it is called \term{inferential statistics}.\\
\noindent{}Biostatistics is the application of statistical techniques to the life and health science. \\
%%% END ADDITION
...
\begin{figure}[h]
	\centering
	\subfigure[]{
		\includegraphics[width=0.48\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/leapBarPlot/leapBarPlot.pdf}
		\label{leapBarPlot}
	}
	\subfigure[]{
		\includegraphics[width=0.48\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/leapBarPlot/leapBarPlotSta.pdf} 
...
%Anyadido lo referente a un indidividuos
 An \term{Observational units},which  is also sometimes called a \term{unit of observation} or \term{case}, is any  individual  that provide information about the research question. Curiously, in Statistics  any object can be an individual, not only humans. For instance, the individuals are  egg clutches in the \data{frog} dataset. 
...
\item[Discrete variable] Not all the values can be taken within the range. Almost always, the values of a discrete variable are interger numbers and they are answering a ``how many'' question.  
  \end{description}
\item[Qualitative or categorical] These variables classify or identify the observational unit. Usually, they are answering a ``what'' question. All the possible values are called the variable's \term{levels}. They can be divided in two subtypes:
  \begin{description}
...
%%%%% SO FAR FIRST PART CHAPTER 1



%%%% CAMBIO: Principles Data collection removed__________
...
% CAMBIO: ANYADIR 
We call (absolute) \term{frequency}  the number of occurrences in the sample of a
  given value for a variable. We call \term{relative frequency} the proportion of occurrences in the sample of a
...
The \term{mode} of a categorical variable is the value (or category) with the highest frequency. The category CT is the mode of the \var{actn3.r577x}  variable for FAMuSS study.  
...
%%%%% CAMBIO: ADDED PERCENTILES


\subsection{Measure of location: percentile}

% CAMBIO: ADDED 
A 80\textsuperscript{th} \term{percentile} is a value such that a  80 percent of  the values are lower than this value. Consequently, the median is the 50\textsuperscript{th} percentile. There are several ways to calculate percentile, we are goint to use the procedure chosen by R. 
...
%
%\begin{align*}
%x_1=&-0.94  &x_2 = &-0.85  &x_3 =& -0.96  &x_4 =& 1.22  &x_5 =& -0.61
%\\
%x_6 =& 0.47  &x_7 =& -0.63  &x_8 =& 0.95  &x_9 =& 1.2   
%\end{align*}
}
...
\begin{figure}[h]
	...
	\subfigure[]{
		...
		{ch_01a_intro_to_data_oi_biostat/figures/famussHist/famussHist}
		\label{famussHist}
	}
	\subfigure[]{
		\includegraphics[width=0.31\textwidth]
		{ch_01a_intro_to_data_oi_biostat/figures/famussBoxPlot/famussBoxPlot}
		\label{famussBoxPlot}
	}
...
%%% THIS SECTION HAS BEEN REMOVED FOR VET
...
% 		{ch_01a_intro_to_data_oi_biostat/figures/wdiIncomeHistRegTransformed/wdiIncomeHistReg}
% 		\label{incomeHistReg}
% 	}
% 	\subfigure[]{
% 		\includegraphics[width=0.485\textwidth]
% 		{ch_01a_intro_to_data_oi_biostat/figures/wdiIncomeHistRegTransformed/wdiIncomeHistLog}
% 		\label{incomeHistLog}
% 	}
...
%___________
%%%% CAMBIO: Only comparison numerical with two groups. The other parts commented 
...
% 	\subfigure[]{
% 		\includegraphics[width=0.485\textwidth]
% 		{ch_01a_intro_to_data_oi_biostat/figures/nhanesHeightWeight/nhanesHeightWeight}
% 		\label{nhanesHeightWeight}
% 	}
% 	\subfigure[]{
% 		\includegraphics[width=0.485\textwidth]
% 		{ch_01a_intro_to_data_oi_biostat/figures/nhanesHeightBMI/nhanesHeightBMI}
...
% \begin{figure}
% 	\centering
% 	\includegraphics[width=0.8\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/posNegCorPlots/posNegCorPlots}
...
% 	\centering
% 	\subfigure[]{
% 		\includegraphics[width=0.485\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/famussSegBar/famussSegBarA}
% 		\label{famussSegBarA}
% 	}
% 	\subfigure[]{
% 		\includegraphics[width=0.485\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/famussSegBar/famussSegBarStaA} 
...
% 	\centering
% 	\subfigure[]{
% 		\includegraphics[width=0.485\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/famussSegBar/famussSegBarB} 
% 		\label{famussSegBarB}
% 	}
% 	\subfigure[]{
% 		\includegraphics[width=0.485\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/famussSegBar/famussSegBarStaB} 
...
%%%%% CAMBIO: ALL THe SECTION OF Exploratory data analysis has been removed 
...
% \begin{figure}[h]
% 	\centering
% 	\includegraphics[width=0.8\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/ddsExpHist/ddsExpHist}
...
% 	\subfigure[]{
% 		\includegraphics[width=0.485\textwidth]
% 		{ch_01a_intro_to_data_oi_biostat/figures/ddsAgeHist/ddsAgeHist}
% 		\label{ddsAgeHist}
% 	}
% 	\subfigure[]{
% 		\includegraphics[width=0.485\textwidth]
% 		{ch_01a_intro_to_data_oi_biostat/figures/ddsAgeCohortPlot/ddsAgeCohortPlot}
...
% \begin{figure}[h]
% 	\centering
% 	\includegraphics[width=\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/ddsEthnicityPlot/ddsEthnicityPlot}
...
% \begin{figure}[h]
% 	\centering
% 	\includegraphics[width=0.7\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/ddsGenderPlot/ddsGenderPlot}
...
% \begin{figure}[h]
% 	\centering
% 	\includegraphics[width=\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/ddsExpAge/ddsExpAge}
...
% \begin{figure}[h]
% 	\centering
% 	\includegraphics[width=0.99\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/ddsExpEthnicity/ddsExpEthnicity}
...
% \begin{figure}[h]
% 	\centering
% 	\includegraphics[width=0.51\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/ddsExpGender/ddsExpGender}
...
% \begin{figure}[h]
% 	\centering
% 	\includegraphics[width=0.6\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/ddsExpHispWhite/ddsExpHispWhite}
...
% 		{ch_01a_intro_to_data_oi_biostat/figures/ddsAgeCohortPlot/ddsHispAgeCohortPlot}
% 		\label{ddsHispAgeCohortPlot}
% 	}
% 	\subfigure[]{
% 		\includegraphics[width=0.46\textwidth]
% 		{ch_01a_intro_to_data_oi_biostat/figures/ddsAgeCohortPlot/ddsWhiteAgeCohortPlot}
...
% \begin{center}
% 	\includegraphics[height=1.25in]{ch_01a_intro_to_data_oi_biostat/figures/ddsConfounding/ddsConfounding.png}
% \end{center}
...
% 	\subfigure[]{
% 		\includegraphics[width=0.65\textwidth]
% 		{ch_01a_intro_to_data_oi_biostat/figures/golubSmall/golubSmallHist}
% 		\label{golubSmallHist}
% 	}
% 	\subfigure[]{
% 		\includegraphics[width=0.3\textwidth]
% 		{ch_01a_intro_to_data_oi_biostat/figures/golubSmall/golubSmallBoxPlot}
...
% 	\subfigure[]{
% 		\includegraphics[width=0.8\textwidth]
% 		{ch_01a_intro_to_data_oi_biostat/figures/golubPlots/golubHist}
% 		\label{golubHist}
% 	}
% 	\subfigure[]{
% 		\includegraphics[width=0.65\textwidth]
% 		{ch_01a_intro_to_data_oi_biostat/figures/golubPlots/golubBoxPlot}
% 		\label{golubBoxPlot}
% 	}
...
% \begin{figure}[h]
% 	\centering
% 	{\includegraphics[width=\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/golubPrediction/golubPrediction.png}
...
% \end{nexercise}
% \end{exercisewrap}
% \footnotetext{Since $V_{AML} = 26,386$ and $V_{ALL} = 127,968$, Patient 10 is predicted to have ALL.}
...
% 	\subfigure[]{
% 		\includegraphics[width=0.485\textwidth]
% 		{ch_01a_intro_to_data_oi_biostat/figures/arenosaBoxplot/arenosaBoxplot.pdf}
% 		\label{arenosaBoxplot}
% 	}
% 	\subfigure[]{
% 		\includegraphics[width=0.485\textwidth]
% 		{ch_01a_intro_to_data_oi_biostat/figures/arenosaBoxplot/arenosaBoxplotLog.pdf}
...
% \begin{figure}[h]
% 	\centering
% 	\includegraphics[width=0.7\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/arenosaResponseBoxplot/arenosaResponseBoxplot}
...
% \begin{figure}[h]
% 	\centering
% 	\includegraphics[width=0.48\textwidth]{ch_01a_intro_to_data_oi_biostat/figures/arenosaVisFigs/Fig4_PB}
...
% \begin{figure}[h]
% 	\centering
% 	\includegraphics[width=0.5\textwidth]{ch_01a_intro_to_data_oi_biostaty/figures/arenosaVisFigs/Fig3_PB}
